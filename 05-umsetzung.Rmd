...
```{r, echo=FALSE, fig.cap="Abschnitt: Ausleihen & Zurückgeben"}
...
```{r, echo=FALSE, fig.cap="Abschnitt: Gruppen des ausgewählten Typs"}
...
```{r, echo=FALSE, fig.cap="Abschnitt: Dateien"}
