...
In der *Dateiverwaltung* können PDF-Dateien als Informationsmaterial in den Reitern *Gruppen*, *Typen* und *Untertypen* hochgeladen werden, siehe Abbildung \ref(fig:file_management_overview).

```{r file_management_overview, echo=FALSE, fig.cap="Übersicht: Ausleihübersicht"}
knitr::include_graphics("./img/file_management_overview.png")
```
